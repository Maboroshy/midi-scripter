...
class MouseEvent(midiscripter.base.msg_base.AttrEnum):
    ...
    """Left button press and release. Not assigned to messages generated by [`MouseIn`][midiscripter.MouseIn] 
       but can be sent with [`MouseOut`][midiscripter.MouseOut]."""
    MIDDLE_CLICK = 'MIDDLE_CLICK'
    """Middle button press and release. Not assigned to messages generated by [`MouseIn`][midiscripter.MouseIn] 
       but can be sent with [`MouseOut`][midiscripter.MouseOut]."""
    RIGHT_CLICK = 'RIGHT_CLICK'
    """Right button press and release. Not assigned to messages generated by [`MouseIn`][midiscripter.MouseIn] 
       but can be sent with [`MouseOut`][midiscripter.MouseOut]."""
